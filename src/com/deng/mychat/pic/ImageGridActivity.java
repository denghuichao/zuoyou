...
import com.deng.mychat.pic.ImageGridAdapter.TextCallback;
...
public class ImageGridActivity extends Activity {
	...
	Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
			case 0:
				Toast.makeText(ImageGridActivity.this, "最多选择15张图片", 400).show();
				break;
	...
	public void buttonClick(View v)
	{
		switch (v.getId())
		{
			case R.id.img_grid_cancel:finish();break;
		}
	}
