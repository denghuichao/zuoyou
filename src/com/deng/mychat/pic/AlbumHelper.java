...
public class AlbumHelper {
	final String TAG = "PIC";//getClass().getSimpleName();
	Context context;
	ContentResolver cr;
	...
	void buildImagesBucketList() {
		...
		if (cur.moveToFirst()) {
			...
			//int timeIndex = cur.getColumnIndexOrThrow(Media.DATE_MODIFIED);
			// 获取图片总数
			...
			do {
				...
				//String addTime=cur.getString(timeIndex);
