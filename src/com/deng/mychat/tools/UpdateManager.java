...
public class UpdateManager {
	...
	public void checkAppUpdate(final Context context, final boolean isShowMsg){
		...
		if(isShowMsg){
			if(mProDialog == null)
				mProDialog = ProgressDialog.show(mContext, null, "正在�?��，请稍后...", true, true);
...
//					UIHelper.ToastMessage(mContext, R.layout.toastmessage_text, "你的APP版本过低不建议继续使用，将会自动�?���?, Toast.LENGTH_SHORT);
